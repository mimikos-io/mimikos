...
func TestFingerprint_Determinism(t *testing.T) {
	...
	seed1 := Fingerprint("GET", "/pets", query, body)
	seed2 := Fingerprint("GET", "/pets", query, body)
...
func TestFingerprint_QueryOrderIndependence(t *testing.T) {
	...
	seed1 := Fingerprint("GET", "/pets", q1, nil)
	seed2 := Fingerprint("GET", "/pets", q2, nil)
...
func TestFingerprint_JSONBodyKeyOrderIndependence(t *testing.T) {
	...
	seed1 := Fingerprint("POST", "/pets", nil, body1)
	seed2 := Fingerprint("POST", "/pets", nil, body2)
...
func TestFingerprint_MethodDifferentiation(t *testing.T) {
	seed1 := Fingerprint("GET", "/pets", nil, nil)
	seed2 := Fingerprint("POST", "/pets", nil, nil)
...
func TestFingerprint_PathDifferentiation(t *testing.T) {
	seed1 := Fingerprint("GET", "/pets", nil, nil)
	seed2 := Fingerprint("GET", "/users", nil, nil)
...
func TestFingerprint_NonJSONBody(t *testing.T) {
	...
	seed1 := Fingerprint("POST", "/upload", nil, body)
	seed2 := Fingerprint("POST", "/upload", nil, body)
...
func TestFingerprint_EmptyBodyEqualsNilBody(t *testing.T) {
	seed1 := Fingerprint("GET", "/pets", nil, nil)
	seed2 := Fingerprint("GET", "/pets", nil, []byte{})
...
func TestFingerprint_EmptyQueryEqualsNilQuery(t *testing.T) {
	seed1 := Fingerprint("GET", "/pets", nil, nil)
	seed2 := Fingerprint("GET", "/pets", url.Values{}, nil)
...
func TestFingerprint_QueryPresenceChangesFingerprint(t *testing.T) {
	seed1 := Fingerprint("GET", "/pets", nil, nil)
	seed2 := Fingerprint("GET", "/pets", url.Values{"limit": {"10"}}, nil)
...
func TestFingerprint_BodyPresenceChangesFingerprint(t *testing.T) {
	seed1 := Fingerprint("POST", "/pets", nil, nil)
	seed2 := Fingerprint("POST", "/pets", nil, []byte(`{"name":"Fido"}`))
...
func TestFingerprint_SeparatorCollision(t *testing.T) {
	...
	seed1 := Fingerprint("GET", "/a||c", nil, nil)
	seed2 := Fingerprint("GET", "/a", nil, []byte("c"))
...
func TestFingerprint_LargeIntegerPrecision(t *testing.T) {
	...
	seed1 := Fingerprint("POST", "/tx", nil, body1)
	seed2 := Fingerprint("POST", "/tx", nil, body2)
...
func TestFingerprint_PathParameterDifferentiation(t *testing.T) {
	...
	seed1 := Fingerprint("GET", "/users/123", nil, nil)
	seed2 := Fingerprint("GET", "/users/456", nil, nil)
